...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_6004, 238, 383),
	ID(DataMask_1001), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_6003, 21, 14),
	ID(Data_Mask_Uebung), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 0, 0, 
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(70), WORD(71), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_PlusPlus, 3, 26),
	...
	ID(Button_6003), TYPEID_BUTTON, WORD(111), WORD(60), 14, 12, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 15),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_6004), TYPEID_BUTTON, WORD(235), WORD(59), 28, 12, 1, 0, 1, 1, 
		XYREF(OutputString_11007, -10, 17),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(OutputString_PlusPlus), TYPEID_OUTSTR, WORD(63), WORD(25), COLOR_YELLOW, ID(FontAttributes_Default), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(111), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(6), 'z', 'ü', 'r', 'ü', 'c', 'k', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(257), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(10), 'H', 'a', 'u', 'p', 't', 's', 'e', 'i', 't', 'e', 0,
	...
	ID(LinearBargraph_Gesamtzaehler), TYPEID_OUTLINBAR, WORD(60), WORD(136), COLOR_BLACK, COLOR_RED, 39, 11, 
		WORD(0), WORD(100), ID(NumberVariable_Gesamtzaehler), WORD(0), ID(ID_NULL), WORD(80), 0, 
	ID(LinearBargraph_Tageszaehler), TYPEID_OUTLINBAR, WORD(60), WORD(137), COLOR_BLACK, COLOR_RED, 39, 11, 
	...
	ID(FontAttributes_23000), TYPEID_FONTATTR, COLOR_RED, 3, 0, 128, 0, 
